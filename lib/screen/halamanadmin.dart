...
import 'package:jelajahbaturaden/screen/listwisata.dart';
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => FormPostingWisata()),
                    );
                  },
                  child: const Text(
                    'Posting / Manajemen Konten',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => WisataListPage()),
                    );
                  },
                  child: const Text(
                    'Edit Data Wisata',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => PengajuanAdminPage()),
                    );
                  },
                  child: const Text(
                    'Kelola Request Wisata',
                    style: TextStyle(fontSize: 16, color: Colors.white),
                  ),
                ),
              ),
